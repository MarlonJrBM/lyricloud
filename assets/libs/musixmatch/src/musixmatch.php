...
class MusicXMatch
{
    ...
    public function add_param($param, $query_string) {
        $this->_query_parameters[$param] = $query_string;
        return $this;
    }
     ...
     */
    public function execute_request($query_type, $ch = null)
    {
        $url = $this->build_query_url($query_type);
     ...
     */
    public function build_query_url($query_type)
    {
